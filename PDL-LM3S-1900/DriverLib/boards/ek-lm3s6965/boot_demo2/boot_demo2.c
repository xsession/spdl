...
main(void)
{
    ...
    //
    OSRAM128x64x4StringDraw("Boot Loader Demo Two", 4, 4, 15);
    OSRAM128x64x4StringDraw("Press the select", 16, 28, 15);
    OSRAM128x64x4StringDraw("button to start the", 6, 36, 15);
    OSRAM128x64x4StringDraw("boot loader.", 28, 44, 15);
    ...
    //
    OSRAM128x64x4StringDraw("The boot loader is", 10, 20, 15);
    OSRAM128x64x4StringDraw(" now running and ", 12, 28, 15);
    OSRAM128x64x4StringDraw(" awaiting an update ", 4, 36, 15);
    OSRAM128x64x4StringDraw("over UART0 at", 24, 44, 15);
    OSRAM128x64x4StringDraw("115,200, 8-N-1.", 18, 52, 15);
