...
PrintValue(unsigned long ulValue)
{
    ...
    pcBuffer[8] = '\0';
    OSRAM128x64x4StringDraw(pcBuffer, 42, 24, 15);
}
...
main(void)
{
    ...
    OSRAM128x64x4StringDraw("Bit banding...", 24, 8, 15);
    ...
    if(ulErrors)
    {
        OSRAM128x64x4StringDraw("Errors!", 42, 40, 15);
    }
    else
    {
        OSRAM128x64x4StringDraw("Success!", 42, 40, 15);
    }
