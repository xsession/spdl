...
main(void)
{
    ...
    //
    OSRAM128x64x4StringDraw("Boot Loader Demo One", 4, 4, 15);
    OSRAM128x64x4StringDraw("The boot loader is", 10, 20, 15);
    OSRAM128x64x4StringDraw("now running and", 18, 28, 15);
    OSRAM128x64x4StringDraw("awaiting an update", 10, 36, 15);
