...
Timer0IntHandler(void)
{
    ...
    //
    IntMasterDisable();
    OSRAM128x64x4StringDraw(HWREGBITW(&g_ulFlags, 0) ? "1" : "0", 48, 32, 15);
    IntMasterEnable();
}
...
Timer1IntHandler(void)
{
    ...
    //
    IntMasterDisable();
    OSRAM128x64x4StringDraw(HWREGBITW(&g_ulFlags, 1) ? "1" : "0", 90, 32, 15);
    IntMasterEnable();
}
...
main(void)
{
    ...
    OSRAM128x64x4StringDraw("Timers example", 18, 24, 15);
    OSRAM128x64x4StringDraw("T1: 0  T2: 0", 24, 32, 15);
