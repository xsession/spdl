...
main(void)
{
    ...
    {
        OSRAM128x64x4StringDraw("This part has no", 12, 24, 15);
        OSRAM128x64x4StringDraw("PWM", 60, 32, 15);
        DiagExit(0);
    }
    ...
    //
    OSRAM128x64x4StringDraw("Generating PWM", 18, 24, 15);
    OSRAM128x64x4StringDraw("on PG2 and PG3", 18, 32, 15);
