...
main(void)
{
    ...
    {
        OSRAM96x16x1StringDraw("This part has no", 0, 0);
        OSRAM96x16x1StringDraw("PWM", 36, 1);
        DiagExit(0);
    }
    ...
    //
    OSRAM96x16x1StringDraw("Generating PWM", 6, 0);
    OSRAM96x16x1StringDraw("on PD0 and PD1", 6, 1);
