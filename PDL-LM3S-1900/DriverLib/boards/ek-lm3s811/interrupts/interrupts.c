...
DisplayIntStatus(void)
{
    ...
    pcBuffer[3] = '\0';
    OSRAM96x16x1StringDraw(pcBuffer, 24, 1);
    ...
    pcBuffer[1] = (ulTemp & 2) ? '2' : ' ';
    pcBuffer[2] = (ulTemp & 4) ? '3' : ' ';
    OSRAM96x16x1StringDraw(pcBuffer, 78, 1);
}
...
main(void)
{
    ...
    OSRAM96x16x1StringDraw("Act:    Pend:   ", 0, 1);
    ...
    //
    OSRAM96x16x1StringDraw("Equal Priority  ", 0, 0);
    ...
    //
    OSRAM96x16x1StringDraw("Dec. Priority   ", 0, 0);
    ...
    //
    OSRAM96x16x1StringDraw("Inc. Priority   ", 0, 0);
    ...
    //
    OSRAM96x16x1StringDraw("Int Priority    ", 0, 0);
    if(ulError)
    {
        OSRAM96x16x1StringDraw("=: P  >: P  <: P", 0, 1);
        if(ulError & 1)
        {
            OSRAM96x16x1StringDraw("F", 18, 1);
        }
        if(ulError & 2)
        {
            OSRAM96x16x1StringDraw("F", 54, 1);
        }
        if(ulError & 4)
        {
            OSRAM96x16x1StringDraw("F", 90, 1);
        }
    }
    else
    {
        OSRAM96x16x1StringDraw("Success.        ", 0, 1);
    }
