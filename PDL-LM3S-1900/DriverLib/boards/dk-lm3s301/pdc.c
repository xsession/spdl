...
//!
//! This function is contained in <tt>pdc.c</tt>, with <tt>pdc.h</tt>
...
PDCRead(unsigned char ucAddr)
{
    ...
    //
    SSIDataPut(SSI0_BASE, (ucAddr & 0x0F) | PDC_RD);
...
PDCWrite(unsigned char ucAddr, unsigned char ucData)
{
    ...
    //
    SSIDataPut(SSI0_BASE, (ucAddr & 0x0F) | PDC_WR);
