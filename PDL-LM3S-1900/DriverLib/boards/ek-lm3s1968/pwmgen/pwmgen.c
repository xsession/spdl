...
main(void)
{
    ...
    {
        RIT128x96x4StringDraw("This part has no", 12, 24, 15);
        RIT128x96x4StringDraw("PWM", 60, 32, 15);
        DiagExit(0);
    }
    ...
    RIT128x96x4StringDraw("on PG2 and PH0", 18, 32, 15);
    ...
    //
    // Set PWM0 to a duty cycle of 25% and PWM2 to a duty cycle of 75%.
    //
    PWMPulseWidthSet(PWM_BASE, PWM_OUT_0, ulPeriod / 4);
    PWMPulseWidthSet(PWM_BASE, PWM_OUT_2, ulPeriod * 3 / 4);

    //
    // Enable the PWM0 and PWM2 output signals.
    //
