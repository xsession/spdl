EK-LM3S1968 Quickstart Application
...
hibernation mode, and the red LED will turn on.  Hibernation mode will
be exited by pressing the select push button.  The select push button will
