...
#define DEVICE_IS_SANDSTORM                                                \
    ...
    (((HWREG(SYSCTL_DID0) & SYSCTL_DID0_VER_M) == SYSCTL_DID0_VER_1) && \
     ((HWREG(SYSCTL_DID0) & SYSCTL_DID0_CLASS_M) ==                     \
...
#define DEVICE_IS_REVA2                                                    \
    (((HWREG(SYSCTL_DID0) & SYSCTL_DID0_MAJ_M) == SYSCTL_DID0_MAJ_REVA) && \
     ((HWREG(SYSCTL_DID0) & SYSCTL_DID0_MIN_M) == SYSCTL_DID0_MIN_2))
#endif

#ifndef DEVICE_IS_REVC1
#define DEVICE_IS_REVC1                                                    \
    (((HWREG(SYSCTL_DID0) & SYSCTL_DID0_MAJ_M) == SYSCTL_DID0_MAJ_REVC) && \
     ((HWREG(SYSCTL_DID0) & SYSCTL_DID0_MIN_M) == SYSCTL_DID0_MIN_1))
#endif
